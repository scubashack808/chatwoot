  ...
  describe 'feature flag columns' do
    ...
    it 'configures the account feature flag extension column' do
      ...
      expect(described_class.flag_mapping['feature_flags_ext_1']).to eq(
        ...
        feature_email_mailbox_actions: 1 << 5,
      ...
      expect(described_class.flag_mapping['feature_flags_ext_1'][:feature_email_mailbox_actions]).to eq(32)
      expect(described_class.flag_mapping['feature_flags_ext_1'][:feature_delayed_automations]).to eq(64)
    end
